            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
                    ...
                    >
                        ...
                        <div className="flex flex-col md:grid md:grid-cols-12 min-h-[500px]">

                            {/* LEFT COLUMN: Contact Info (5 cols) */}
                            <div className="md:col-span-5 bg-[#111111] p-8 flex flex-col border-b md:border-b-0 md:border-r border-white/5 relative overflow-hidden">
                            ...
                            <div className="md:col-span-7 p-8 md:p-10 bg-[#0D0D0D]">
                                {isSent ? (
