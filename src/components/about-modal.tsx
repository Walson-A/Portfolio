...
import { X, Download, MapPin, GraduationCap, Github, Linkedin, Mail, ExternalLink, Phone, Code2, Brain, Wrench, ChevronRight, ChevronLeft } from "lucide-react"
                    ...
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
                        ...
                        >
                            ...
                            <div className="relative flex flex-col h-full">
                                ...
                                <div className="flex flex-row overflow-x-auto snap-x snap-mandatory md:grid md:grid-cols-12 min-h-[450px] h-full no-scrollbar">

                                    {/* LEFT COLUMN: Identity & Contact (5 cols) */}
                                    <div className="min-w-full snap-center md:min-w-0 md:col-span-5 bg-[#111111] p-8 flex flex-col items-center md:items-start border-b md:border-b-0 md:border-r border-white/5 relative overflow-hidden">
                                    ...
                                    <div className="min-w-full snap-center md:min-w-0 md:col-span-7 p-10 flex flex-col relative">
                                            ...
                                            <div className="flex gap-4">
                                                ...
                                                <button
                                                    onClick={() => {
                                                        ...
                                                        link.href = "/CV Walson Argan RENE.pdf"
                                                        link.download = "CV Walson Argan RENE.pdf"
