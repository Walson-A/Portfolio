...
## Parcours (Timeline)
- **2023**: StickHunt (project) - Jeu 3D multijoueur de type 'prop-hunt' en temps réel développé avec Unity et C#.
- **2024**: OCR WSS (project) - Logiciel de résolution automatique de grilles de mots cachés.
